...
(function (root) {
  ...
  const App = {};
  const TABS = { plan: root.PlanUI, recipes: root.RecipesUI, parts: root.PartsUI, data: root.DataUI, settings: root.SettingsUI };
  ...
  App.help = function () {
    UI.modal('<h2>How to use</h2><div class="help">' +
      ...
      '<h3>4. Calendar</h3><p>Set shifts, breaks, working days and holidays. Add a max worker count to get capacity warnings.</p>' +
